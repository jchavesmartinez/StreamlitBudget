...
with st.expander("Metricas y resultados"):
    ...
    DiarioFinal1['Saldo Disponible %'] = 100 - (DiarioFinal1['Saldo Disponible']/DiarioFinal1['Saldo Presupuestado']*100)
    ...
    with tab2:
        st.dataframe(DiarioFinalActual,use_container_width=True)
