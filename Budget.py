        ...
        if cuenta_option2=='Tarjeta credito Jose':
            ...
            if st.checkbox("Pagar tarjeta Jose"):
                ...
                with st.form("my_form21",key='PagoJose'):
                    ...
                    submitted31 = st.form_submit_button("Confirmar pago",key='pagojose3')
                
                if submitted31:
                    db.COLLECTION_DIARIO.insert_one({"_id": len(Diario)+1, "Motivo": 'Tasa 0', "Tipo": 'Gasto', "Monto": monto_ingreso21, "Fecha": fecha, "Escenario": '2. Actual', "Cuenta": 'Tarjeta credito Jose', "Nota": 'Pago tarjeta de credito Jose'})
                    db.COLLECTION_DIARIO.insert_one({"_id": len(Diario)+2, "Motivo": 'Tasa 0', "Tipo": 'Gasto', "Monto": -monto_ingreso21, "Fecha": fecha, "Escenario": '2. Actual', "Cuenta": cuenta_option21, "Nota": 'Pago tarjeta de credito Jose'})
                    st.success('This is a success message!!', icon="✅")
                    st.experimental_rerun()
